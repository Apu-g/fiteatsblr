...
export default function Footer() {
  return (
    <footer className="bg-ink">
      <div className="container-app border-t border-white/10 py-8 sm:py-14">
        <div className="grid gap-6 sm:gap-10 md:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          <div>
            ...
            <div className="mt-5 sm:mt-6 flex gap-2.5 sm:gap-3">
              {socials.map(({ label, href, Icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-xl border border-white/10 text-white/60 transition-all duration-300 hover:border-lime hover:bg-lime hover:text-ink"
                >
          ...
          <div>
            <h4 className="heading text-xs sm:text-sm uppercase tracking-[0.16em] text-white/40">
              Quick Links
            </h4>
        ...
        <div className="mt-10 sm:mt-12 flex flex-col items-center justify-between gap-3 sm:gap-4 border-t border-white/10 pt-6 sm:pt-8 sm:flex-row">
          <p className="text-xs text-white/40">
            © {new Date().getFullYear()} FitEatsBLR. All rights reserved.
          </p>
          <div className="flex gap-4 sm:gap-6">
            <a href="#" className="text-[0.65rem] sm:text-xs text-white/40 transition-colors hover:text-lime">
              Privacy Policy
            </a>
            <a href="#" className="text-[0.65rem] sm:text-xs text-white/40 transition-colors hover:text-lime">
              Terms of Service
